...
FIRST_EVENT_NUMBER_IN_FILES = [FIRST_EVENT_NUMBER_IN_FILE, FIRST_EVENT_NUMBER_IN_FILE_V6]
...
def test_loop_over_events():
    ...
    for example_file_path, first_event_number, evt_jump in zip( EXAMPLE_FILE_PATHS, FIRST_EVENT_NUMBER_IN_FILES, EVENT_JUMPS):
        n_events = 10
...
def test_length_with_limit():
    ...
    for example_file_path in EXAMPLE_FILE_PATHS:
        inputfile_reader = NectarCAMEventSource(input_url=example_file_path,max_events=n_events)
